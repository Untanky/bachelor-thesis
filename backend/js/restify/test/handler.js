...
describe('blog post handler', () => {
  describe('find all posts', () => {
    it('should return all posts', async () => {
      ...
      expect(responseMock.send).to.have.been.calledOnceWith(200, postlist);
    });
  });
  ...
  describe('create a new post', () => {
    it('should create new post', async () => {
      ...
      expect(responseMock.send).to.have.been.calledOnceWith(204);
    });
    ...
    it('should send status 400 when id is given', async () => {
      ...
      expect(createSpy).to.have.been.calledOnce;
      expect(responseMock.send).to.have.been.calledOnceWith(400);
    });
  });
  ...
  describe('update a post', () => {
    ...
    it('should send status 404 when post with id doesn\'t exist', async () => {
      ...
      expect(updateSpy).to.have.been.calledOnceWith(post4);
      expect(responseMock.send).to.have.been.calledOnceWith(404);
    });
  });
